...
todomvc.controller('TodoCtrl', function TodoCtrl($scope, $location, $firebaseArray, $firebaseObject) {
	...
	$scope.addTodo = function () {
        ...
        // $scope.todos.$add({    //$add is firebases version of .push after a firebase array has been created.
		// 	title: newTodo,
		// 	completed: false
		// });
	...
	$scope.doneEditing = function (todo) {
		...
		if (title) {
			...
			//2. Firebase way
			// $scope.todos.$save(todo);  //$save tells firebase to save a change that has been made
	...
	$scope.removeTodo = function (todo) {
        ...
        //2. Firebase way
		// $scope.todos.$remove(todo);  //$remove is another firebase method
